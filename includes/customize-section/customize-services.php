<?php
    ...
    /* Services - Main title*/
    $wp_customize->add_setting('mystart_main_services_title', array(
    ...
    /* Services - sub title*/
    $wp_customize->add_setting('mystart_services_sub_title', array(
        'default' => '',
        'sanitize_callback' => 'wp_filter_nohtml_kses'
        ));
    ...
    $wp_customize->add_setting('mystart_services_item_title_1', array(
        'default' => '',
        'sanitize_callback' => 'wp_filter_nohtml_kses'
        ));
    ...
    $wp_customize->add_setting('mystart_services_item_icon_1', array(
    ...
    $wp_customize->add_setting('mystart_services_item_desc_1', array(
        'default' => '',
        'sanitize_callback' => 'wp_filter_nohtml_kses'
        ));
    ...
    $wp_customize->add_setting('mystart_services_item_title_2', array(
        'default' => '',
        'sanitize_callback' => 'wp_filter_nohtml_kses'
        ));
    ...
    $wp_customize->add_setting('mystart_services_item_icon_2', array(
        'default' => 'glyphicon-phone',
        'sanitize_callback' => 'wp_filter_nohtml_kses'
        ));
    ...
    $wp_customize->add_setting('mystart_services_item_desc_2', array(
        'default' => '',
        'sanitize_callback' => 'wp_filter_nohtml_kses'
        ));
    ...
    $wp_customize->add_setting('mystart_services_item_title_3', array(
        'default' => '',
        'sanitize_callback' => 'wp_filter_nohtml_kses'
        ));
    ...
    $wp_customize->add_setting('mystart_services_item_icon_3', array(
        'default' => 'glyphicon-phone',
        'sanitize_callback' => 'wp_filter_nohtml_kses'
        ));
    ...
    $wp_customize->add_setting('mystart_services_item_desc_3', array(
        'default' => '',
        'sanitize_callback' => 'wp_filter_nohtml_kses'
        ));
